  			...
  			dataGrid:{
  				title:'系统用户授权',
	   			...
	   			columns:[[
						...
						{field:'email',title:'邮箱账号',align:'center',width:120,sortable:true},
						...
						{field:'loginTime',title:'登录时间',align:'center',width:120,sortable:true},
						{field:'roleStr',title:'授予角色',align:'center',width:150,sortable:true}
				]],
				toolbar:[
