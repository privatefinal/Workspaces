...
<html>
  ...
  <body class="easyui-layout">
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >CopyRight &copy; 2013 enter 版权所有. &nbsp;&nbsp;官方网址: www.enter.com</div>
	</div>
	<!-- 中间内容页面 -->
