...
#login .logo {
 ...
 <body>
  ...
  <div id="login">
   <div class="ribbon" style="background-image:url(plug-in/login/images/typelogin4.png);"></div>
   <div class="inner">
    <div class="logo">
     <img src="plug-in/login/images/toplogo3.png"/>
    </div>
    <div class="formLogin">
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="#" title="演示系统">ZhuanGe</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="ZhuanGe 演示系统">ZhuanGe&nbsp;邮箱：18813907332@126.com</a></span>
   </div>
  </div>
  <!-- Link JScript-->
